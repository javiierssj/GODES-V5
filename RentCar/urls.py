...
from .views import inicio, informacion, perfil, ordenes, registro, registro_auto, registarauto, inicioSesion, registrarusuario, login_view ,logout_view, catalogo_planilla, info_auto
